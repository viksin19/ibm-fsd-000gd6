...
public class ProjectServiceImpl implements ProjectService {
	...
	@Override
	public TasksDto createTask(CreateTasksRequestModel taskDetail) {
		System.out.println(taskDetail.toString());
		ResponseEntity<TasksDto> tDto =  (ResponseEntity<TasksDto>) projectFeignClient.createTask(taskDetail);
		TasksDto taskDto =  tDto.getBody();
		return taskDto;
	}
